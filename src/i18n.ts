...
const EN: Dict = {
    ...
    'wf.empty': 'No workflows in this project yet.',
    'wf.panelTitle': 'Claude Workflows',
    'wf.doneGroup': '{0} finished',
    'wf.loading': 'Loading…',
    'wf.session': 'session {0}',
    'wf.sessionLive': 'session {0} (open)',
    'wf.taskChip': 'AGENTS',
    'wf.kind.command_execution': 'cmd',
    'wf.kind.file_read': 'read',
    'wf.kind.file_change': 'edit',
    'wf.kind.code_search': 'find',
    'wf.kind.web_search': 'web',
    'wf.kind.agent_message': 'says',
    'wf.kind.tool': 'tool',
    'wf.kind.report': 'report',
    'wf.group.command_execution': '{0} commands',
    'wf.group.file_read': '{0} reads',
    'wf.group.code_search': '{0} finds',
    'wf.group.web_search': '{0} web lookups',
    ...
    'wf.took': 'took ',
    'wf.agentN': 'Agent {0}',
    'wf.headAgents': '{0} agents',
    'wf.headTokens': '{0} tokens',
    'wf.tokensExact': '{0} tokens',
    'wf.phaseOther': 'Other',
    'wf.unitSec': 's',
    'wf.unitMin': 'm',
    'wf.unitMan': '',
    ...
    'cx.setup.msg': 'The Codex progress panel needs the codex-rescue plugin for Claude Code. It is not bundled with this extension because it runs Codex with write access to your workspace, so you install it yourself. In Claude Code: /plugin marketplace add comonetso/claudeStateBar, then /plugin install codex-rescue@comonetso. Read the guide first to see what it does.',
    'cx.setup.open': 'Open guide',
    'cx.plugin.switch': 'Your codex_rescue skill is a manual copy in ~/.claude/skills and will not update by itself. Switching to the plugin is strongly recommended. In Claude Code: /plugin marketplace add comonetso/claudeStateBar, then /plugin install codex-rescue@comonetso. Then delete ~/.claude/skills/codex_rescue and restart Claude Code.',
    'cx.plugin.removeOld': 'The codex-rescue plugin is installed, so the old manual copy at {0} is no longer needed. Delete the old copy?',
    'cx.plugin.deleteOld': 'Delete old copy',
    'cx.plugin.deleted': 'The old codex_rescue copy was moved to the trash. Restart Claude Code so open conversations pick up the plugin.',
    'cx.plugin.deleteFailed': 'Could not move {0} to the trash: {1}. Delete that folder yourself, then restart Claude Code.',
    ...
    'dots.since': 'started {0}',
    // Background task panel — commands Claude ran with run_in_background, and monitors.
    'menu.sepBgTasks': 'Background',
    'menu.viewBgTasks': 'Background tasks ({0})',
    'menu.noBgTasks': 'Background tasks',
    'bg.panelTitle': 'Claude Background Tasks',
    'bg.title': '⏳ Claude Background Tasks',
    'bg.scope': 'In the sessions on the status bar: what Claude ran in the background, and ordinary commands that ran over {0} min.',
    'bg.group.background': 'Background',
    'bg.group.long': 'Long commands · over {0} min',
    'bg.groupCounts': '{0} running · {1} finished',
    'bg.groupEmpty': 'None.',
    'bg.doneGroupLong': '{0} finished',
    'bg.waiting': 'Claude is waiting for this command. Its output is recorded when it ends.',
    'bg.empty': 'No background tasks in the sessions on the status bar.',
    'bg.kind.command': 'Command',
    'bg.kind.monitor': 'Monitor',
    'bg.running': 'running',
    'bg.completed': 'done',
    'bg.failed': 'failed · exit {0}',
    'bg.failedNoCode': 'failed',
    'bg.stopped': 'stopped',
    'bg.doneGroup': '{0} finished',
    'bg.doneGroupMore': 'latest {0} of {1}',
    'bg.nRunning': '{0} running',
    'bg.nFinished': '{0} finished',
    'bg.clearDone': 'Clear the finished tasks from this list (no file is touched)',
    'bg.cleared': 'Cleared {0} finished task(s) from the list',
    'bg.taskId': 'task {0}',
    'bg.output': 'Output',
    'bg.events': '{0} events',
    'bg.outputGone': 'The output file is gone — Claude Code keeps it in a temporary folder.',
    'bg.outputEmpty': 'No output yet.',
    'menu.sepCodex': 'Codex',
    ...
    'menu.codexAutoUpdate': '{0} auto-update: off',
    'menu.codexAutoUpdateDesc': 'select to turn it on',
    'cx.autoupdate.notice': 'Auto-update is off for the {1} plugin on {0}. Turn it on to receive new versions automatically.',
    'cx.autoupdate.enable': 'Turn on',
    'cx.autoupdate.later': 'Later',
    'cx.autoupdate.never': "Don't show again here",
    'cx.autoupdate.done': '{1} auto-update is on for {0}. It takes effect when you restart Claude Code.',
    'cx.autoupdate.failed': 'Could not change the settings file on {0}: {1}',
    'cx.autoupdate.local': 'this PC',
    'cx.autoupdate.remote': 'server {0}',
    ...
    // Claude Status panel (usage + stats)
    'menu.claudeStatus': 'Claude Status…',
    'menu.claudeStatusDesc': 'usage limits and lifetime stats',

    'cs.panel.title': 'Claude Status',
    'cs.tab.usage': 'Usage',
    'cs.tab.stats': 'Stats',
    'cs.refresh': 'Refresh',
    'cs.updated': 'Updated {0}',
    'cs.loading': 'Reading local session data…',
    'cs.unit.day': 'd',
    'cs.unit.hour': 'h',
    'cs.unit.min': 'm',
    'cs.unit.sec': 's',

    'cs.sess.title': 'This conversation',
    'cs.sess.none': 'No conversation is running on this machine.',
    'cs.sess.wall': 'Total duration',
    'cs.sess.active': 'Active time',
    'cs.sess.activeHint': 'The gap from each message to its reply, added up. Tool runs sit inside that, so it is not pure API latency.',
    'cs.sess.changes': 'Code changes',
    'cs.sess.requests': 'API requests',
    ...
    'cs.usage.limits': 'Plan limits',
    'cs.usage.session': '5-hour window',
    'cs.usage.weekly': 'Current week (all models)',
    'cs.usage.weeklyModel': 'Current week ({0})',
    'cs.usage.resets': 'Resets {0}',
    'cs.usage.unconfigured': 'Plan usage is not set up yet.',
    'cs.usage.authExpired': 'The saved Session Key has expired.',
    'cs.usage.blocked': 'claude.ai blocked the request from this machine.',
    'cs.usage.error': 'Could not read plan usage.',
    'cs.usage.openSettings': 'Open settings',
    'cs.usage.contrib': 'What is contributing to your limits',
    'cs.usage.localNote': 'Approximate, from this machine\'s local session logs. Usage from other devices and from claude.ai is not included.',
    'cs.usage.noLocal': 'No activity recorded in the last 24 hours.',
    'cs.usage.longCtx': 'of your usage was at more than {0} context',
    'cs.usage.longCtxHint': 'Longer sessions cost more even when cached. Use /compact mid-task, and /clear when switching to something new.',
    'cs.usage.skills': 'Skills',

    'cs.stats.activity': 'Activity',
    'cs.stats.totals': 'Totals',
    'cs.stats.byModel': 'By model',
    'cs.stats.totalTokens': 'Total tokens',
    'cs.stats.cost': 'Cost (API rate)',
    'cs.stats.costPartial': 'some models unpriced',
    'cs.stats.favoriteModel': 'Favorite model',
    'cs.stats.sessions': 'Sessions',
    'cs.stats.longestSession': 'Longest session',
    'cs.stats.activeDays': 'Active days',
    'cs.stats.longestStreak': 'Longest streak',
    'cs.stats.currentStreak': 'Current streak',
    'cs.stats.mostActiveDay': 'Most active day',
    'cs.stats.days': '{0} days',
    'cs.stats.messages': '{0} messages',
    'cs.stats.less': 'Less',
    'cs.stats.more': 'More',
    'cs.stats.input': 'Input',
    'cs.stats.output': 'Output',
    'cs.stats.cacheRead': 'Cache read',
    'cs.stats.cacheWrite': 'Cache write',
    'cs.stats.noCache': 'No stats yet — Claude Code builds this up as you use it.',
    'cs.stats.noActivity': 'No activity recorded yet.'
};
...
const KO: Dict = {
    ...
    'wf.empty': '이 프로젝트에 아직 워크플로우가 없습니다.',
    'wf.panelTitle': 'Claude 워크플로우',
    'wf.doneGroup': '끝난 워크플로우 {0}건',
    'wf.loading': '불러오는 중…',
    'wf.session': '세션 {0}',
    'wf.sessionLive': '세션 {0} (열려 있음)',
    'wf.taskChip': '에이전트 묶음',
    'wf.kind.command_execution': '명령',
    'wf.kind.file_read': '읽기',
    'wf.kind.file_change': '수정',
    'wf.kind.code_search': '찾기',
    'wf.kind.web_search': '웹',
    'wf.kind.agent_message': '말',
    'wf.kind.tool': '도구',
    'wf.kind.report': '보고',
    'wf.group.command_execution': '명령 {0}건',
    'wf.group.file_read': '읽기 {0}건',
    'wf.group.code_search': '찾기 {0}건',
    'wf.group.web_search': '웹 {0}건',
    ...
    'cx.setup.msg': 'Codex 진행 패널은 Claude Code용 codex-rescue 플러그인이 있어야 동작합니다. 워크스페이스에 쓰기 권한을 가진 Codex를 실행하는 도구라 확장에 넣지 않았으니 직접 설치하셔야 합니다. Claude Code에서 /plugin marketplace add comonetso/claudeStateBar 를 실행한 뒤 /plugin install codex-rescue@comonetso 를 실행하십시오. 무엇을 하는 도구인지는 가이드를 먼저 읽어 보십시오.',
    'cx.setup.open': '가이드 열기',
    'cx.plugin.switch': 'codex_rescue 스킬이 옛 방식(~/.claude/skills 폴더 복사)으로 설치돼 있어 업데이트가 자동으로 오지 않습니다. 플러그인으로 바꾸기를 강하게 권합니다. Claude Code에서 /plugin marketplace add comonetso/claudeStateBar 와 /plugin install codex-rescue@comonetso 를 차례로 실행한 뒤, ~/.claude/skills/codex_rescue 폴더를 지우고 Claude Code를 다시 여십시오.',
    'cx.plugin.removeOld': 'codex-rescue 플러그인이 설치돼 있어 옛 방식 사본({0})은 더 이상 필요 없습니다. 옛 사본을 삭제할까요?',
    'cx.plugin.deleteOld': '옛 사본 삭제',
    'cx.plugin.deleted': '옛 codex_rescue 사본을 휴지통으로 옮겼습니다. 열려 있는 대화가 플러그인을 쓰도록 Claude Code를 다시 여십시오.',
    'cx.plugin.deleteFailed': '{0} 을(를) 휴지통으로 옮기지 못했습니다: {1}. 그 폴더를 직접 지운 뒤 Claude Code를 다시 여십시오.',
    ...
    'dots.since': '{0} 시작',
    'menu.sepBgTasks': '백그라운드',
    'menu.viewBgTasks': '백그라운드 작업 ({0})',
    'menu.noBgTasks': '백그라운드 작업',
    'bg.panelTitle': 'Claude 백그라운드 작업',
    'bg.title': '⏳ Claude 백그라운드 작업',
    'bg.scope': '상태바에 보이는 세션에서 Claude 가 백그라운드로 돌린 것과, {0}분 넘게 걸린 일반 명령입니다.',
    'bg.group.background': '백그라운드',
    'bg.group.long': '오래 걸린 명령 · {0}분 넘게',
    'bg.groupCounts': '실행 중 {0} · 끝난 {1}',
    'bg.groupEmpty': '없음',
    'bg.doneGroupLong': '끝난 명령 {0}건',
    'bg.waiting': 'Claude 가 이 명령이 끝나길 기다리고 있습니다. 출력은 끝나면 기록됩니다.',
    'bg.empty': '상태바에 보이는 세션에 백그라운드 작업이 없습니다.',
    'bg.kind.command': '명령',
    'bg.kind.monitor': '모니터',
    'bg.running': '실행 중',
    'bg.completed': '완료',
    'bg.failed': '실패 · 종료 코드 {0}',
    'bg.failedNoCode': '실패',
    'bg.stopped': '중지됨',
    'bg.doneGroup': '끝난 작업 {0}건',
    'bg.doneGroupMore': '전체 {1}건 중 최근 {0}건',
    'bg.nRunning': '실행 중 {0}건',
    'bg.nFinished': '끝난 작업 {0}건',
    'bg.clearDone': '끝난 작업을 목록에서 치웁니다 (파일은 건드리지 않음)',
    'bg.cleared': '끝난 작업 {0}건을 목록에서 치웠습니다',
    'bg.taskId': '작업 {0}',
    'bg.output': '출력',
    'bg.events': '이벤트 {0}건',
    'bg.outputGone': '출력 파일이 지워졌습니다 — Claude Code 가 임시 폴더에 두는 파일입니다.',
    'bg.outputEmpty': '아직 출력이 없습니다.',
    'menu.sepCodex': 'Codex',
    ...
    'menu.codexAutoUpdate': '{0} 자동 업데이트: 꺼짐',
    'menu.codexAutoUpdateDesc': '누르면 켭니다',
    'cx.autoupdate.notice': '{0}의 {1} 플러그인은 자동 업데이트가 꺼져 있습니다. 켜면 새 버전을 저절로 받습니다.',
    'cx.autoupdate.enable': '켜기',
    'cx.autoupdate.later': '나중에',
    'cx.autoupdate.never': '여기서 다시 보지 않기',
    'cx.autoupdate.done': '{0}의 {1} 자동 업데이트를 켰습니다. Claude Code를 다시 시작하면 적용됩니다.',
    'cx.autoupdate.failed': '{0}의 설정 파일을 고치지 못했습니다: {1}',
    'cx.autoupdate.local': '이 PC',
    'cx.autoupdate.remote': '서버 {0}',
    ...
    // Claude Status 패널 (사용량 + 통계)
    'menu.claudeStatus': 'Claude 상태…',
    'menu.claudeStatusDesc': '사용 한도와 누적 통계',

    'cs.panel.title': 'Claude 상태',
    'cs.tab.usage': '사용량',
    'cs.tab.stats': '통계',
    'cs.refresh': '새로고침',
    'cs.updated': '{0} 기준',
    'cs.loading': '로컬 세션 기록을 읽는 중…',
    'cs.unit.day': '일',
    'cs.unit.hour': '시간',
    'cs.unit.min': '분',
    'cs.unit.sec': '초',
    ...
    'cs.sess.title': '이번 대화',
    'cs.sess.none': '이 컴퓨터에서 진행 중인 대화가 없습니다.',
    'cs.sess.wall': '전체 시간',
    'cs.sess.active': '작업 시간',
    'cs.sess.activeHint': '메시지마다 답이 오기까지 걸린 시간을 더한 값입니다. 도구 실행 시간이 그 안에 들어 있어 순수 API 시간은 아닙니다.',
    'cs.sess.changes': '코드 변경',
    'cs.sess.requests': 'API 요청',
    'cs.sess.api': 'API 시간',
    ...
    'cs.usage.limits': '요금제 한도',
    'cs.usage.session': '5시간 창',
    'cs.usage.weekly': '이번 주 (전체 모델)',
    'cs.usage.weeklyModel': '이번 주 ({0})',
    'cs.usage.resets': '리셋 {0}',
    'cs.usage.unconfigured': '요금제 사용량이 아직 설정되지 않았습니다.',
    'cs.usage.authExpired': '저장된 Session Key 가 만료되었습니다.',
    'cs.usage.blocked': 'claude.ai 가 이 컴퓨터에서 보낸 요청을 차단했습니다.',
    'cs.usage.error': '요금제 사용량을 읽지 못했습니다.',
    'cs.usage.openSettings': '설정 열기',
    'cs.usage.contrib': '무엇이 한도를 쓰고 있나',
    'cs.usage.localNote': '이 컴퓨터에 남은 대화 기록만으로 계산한 근사치입니다. 다른 기기와 claude.ai 에서 쓴 몫은 빠져 있습니다.',
    'cs.usage.noLocal': '최근 24시간 동안의 기록이 없습니다.',
    'cs.usage.longCtx': '가 {0} 이 넘는 긴 대화에서 나왔습니다',
    'cs.usage.longCtxHint': '대화가 길어지면 캐시가 걸려 있어도 더 비쌉니다. 하던 일이 길어지면 /compact, 다른 일로 넘어갈 때는 /clear 를 쓰십시오.',
    'cs.usage.skills': '스킬별',

    'cs.stats.activity': '활동',
    'cs.stats.totals': '누적',
    'cs.stats.byModel': '모델별',
    'cs.stats.totalTokens': '총 토큰',
    'cs.stats.cost': '비용 (API 환산)',
    'cs.stats.costPartial': '일부 모델 단가 미상',
    'cs.stats.favoriteModel': '가장 많이 쓴 모델',
    'cs.stats.sessions': '세션',
    'cs.stats.longestSession': '가장 긴 세션',
    'cs.stats.activeDays': '활동한 날',
    'cs.stats.longestStreak': '최장 연속',
    'cs.stats.currentStreak': '현재 연속',
    'cs.stats.mostActiveDay': '가장 활발했던 날',
    'cs.stats.days': '{0}일',
    'cs.stats.messages': '메시지 {0}개',
    'cs.stats.less': '적음',
    'cs.stats.more': '많음',
    'cs.stats.input': '입력',
    'cs.stats.output': '출력',
    'cs.stats.cacheRead': '캐시 읽기',
    'cs.stats.cacheWrite': '캐시 쓰기',
    'cs.stats.noCache': '아직 통계가 없습니다. Claude Code 를 쓰는 동안 쌓입니다.',
    'cs.stats.noActivity': '기록된 활동이 없습니다.'
};
