...
const EN: Dict = {
    ...
    'menu.codexAutoUpdate': 'codex_rescue auto-update: off',
    'menu.codexAutoUpdateDesc': 'select to turn it on',
    'cx.autoupdate.notice': 'Auto-update is off for the codex_rescue plugin on {0}. Turn it on to receive new versions automatically.',
    'cx.autoupdate.enable': 'Turn on',
    'cx.autoupdate.later': 'Later',
    'cx.autoupdate.never': "Don't show again here",
    'cx.autoupdate.done': 'codex_rescue auto-update is on for {0}. It takes effect when you restart Claude Code.',
...
const KO: Dict = {
    ...
    'menu.codexAutoUpdate': 'codex_rescue 자동 업데이트: 꺼짐',
    'menu.codexAutoUpdateDesc': '누르면 켭니다',
    'cx.autoupdate.notice': '{0}의 codex_rescue 플러그인은 자동 업데이트가 꺼져 있습니다. 켜면 새 버전을 저절로 받습니다.',
    'cx.autoupdate.enable': '켜기',
    'cx.autoupdate.later': '나중에',
    'cx.autoupdate.never': '여기서 다시 보지 않기',
    'cx.autoupdate.done': '{0}의 codex_rescue 자동 업데이트를 켰습니다. Claude Code를 다시 시작하면 적용됩니다.',
