...
const EN: Dict = {
    ...
    'cx.del.ask': 'Delete the run "{0}".\n\nRaw logs only, or the request/response documents too?\n\nEither way it goes to the trash at the top of this panel, so you can put it back.',
    'cx.del.logsOnly': 'Logs only',
    'cx.del.withDocs': 'Logs + documents',
    ...
    'msg.wfDeleteConfirm': 'Delete this workflow record?\n{0}\n\nIt goes to the trash at the top of this panel, so you can put it back.',
...
const KO: Dict = {
    ...
    'cx.del.ask': '"{0}" 실행을 삭제합니다.\n\n원시 기록만 지울까요, 요청서·응답 문서까지 함께 지울까요?\n\n어느 쪽이든 이 패널 상단의 휴지통으로 들어가므로 다시 꺼낼 수 있습니다.',
    'cx.del.logsOnly': '기록만 삭제',
    'cx.del.withDocs': '기록 + 문서 삭제',
