...
const EN: Dict = {
    ...
    'cx.del.ask': 'Delete the run "{0}".\n\nRaw logs only, or the request/response documents too?\n\nThe documents are the record of what was asked and answered, and are normally committed. Deleting them cannot be undone.',
...
const KO: Dict = {
    ...
    'cx.del.ask': '"{0}" 실행을 삭제합니다.\n\n원시 기록만 지울까요, 요청서·응답 문서까지 함께 지울까요?\n\n문서는 무엇을 묻고 무엇을 답했는지의 기록이며 보통 커밋해서 남깁니다. 지우면 되돌릴 수 없습니다.',
