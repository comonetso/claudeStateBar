...
- **휴지통** — 워크플로우를 지우면 없어지는 게 아니라 옆으로 치워집니다. 패널 상단의 🗑를 열어 되살리거나 완전히 지웁니다
...
카드에서 지운다고 사라지지는 않습니다. **휴지통**으로 옮겨질 뿐이고, 패널 상단의 🗑로 열어 다시 꺼내거나 완전히 지울 수 있습니다. 비우기 전까지는 계속 남습니다. 예외가 둘 있습니다 — 자동 정리는 휴지통을 거치지 않고 바로 지웁니다(디스크를 되찾는 게 목적인데 지운 만큼 휴지통이 차면 의미가 없습니다). 그리고 복구할 때 같은 이름을 이미 다른 파일이 쓰고 있으면 덮어쓰지 않고 그 파일만 휴지통에 남깁니다.
...
어느 쪽을 고르든 파일은 지워지지 않고 패널의 휴지통으로 들어갑니다 — 바로 지우는 경로는
자동 정리뿐입니다.
